...
let testData = [
    ...
    CareRequestRecord(requestorID: 2, patientID: 105, requestedServiceCode: 2, requestedService: "Lab Test", name: "Next: Henry Doe", when: "Tomorrow @ 9:00", address: "Nearby...", patientLatitude: 40, patientLongitude: -75, hasVideo: true, mapLatitude:40, mapLongitude: -75),
    ...
    CareRequestRecord(requestorID: 5, patientID: 230, requestedServiceCode: 5, requestedService: "Vaccination", name: "Done: Cedric Doe", when: "Jan 18 @ 9:30", address: "Nearby", patientLatitude: 37, patientLongitude: 23, hasVideo: false, mapLatitude:37.2, mapLongitude: -75),
