...
let onCallStaffTestData = [
    ...
    OnCallStaffRecord(requestorID: 2, caregiverID: 105, requestedServiceCode: 2, requestedService: "Lab Test", name: "PSW Lucy", professionalTitle: "PSW", address: "Nearby...", caregiverLatitude: 40, caregiverLongitude: -75, hasVideo: true, mapLatitude:40, mapLongitude: -75),
    ...
    OnCallStaffRecord(requestorID: 5, caregiverID: 230, requestedServiceCode: 5, requestedService: "Vaccination", name: "RNA Katia", professionalTitle: "RNA", address: "Nearby", caregiverLatitude: 37, caregiverLongitude: 23, hasVideo: false, mapLatitude:37.2, mapLongitude: -75),
